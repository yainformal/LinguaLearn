...
DEBUG_PARAM = True
GENERATIVE_PARAM = True

class Config:
    def __init__(self, generative_param=GENERATIVE_PARAM):
        ...
        if generative_param:
            self.pretrained_model_name = 'google-t5/t5-base'
        else:
        ...
        self.T5_path = 'moduls/trained_models/T5_lr_2e-5_32_256_v3'
